...
> **2025.06 ~** | **공동 개발** | 166 커밋 중 본인 약 65건 (약 39%)
> **2개 기관**에 적용 · 도서관 정보시스템(KOLAS)과 연계해 개인 맞춤 도서 추천·인증을 제공하는 미들웨어

```mermaid
flowchart LR
    User["키오스크 이용자<br/>RFID 태그"]
    Auth["인증 · 세션<br/>5분 제한"]
    Detail{"도서 상세 조회"}
    KOLAS["도서관 정보시스템<br/>KOLAS"]
    Bookmate["북메이트"]
    Reco["추천 결과<br/>10권 미만 시 인기도서 보충"]

    User --> Auth --> Detail
    Detail -->|소장 도서| KOLAS
    Detail -->|비소장 도서| Bookmate
    Auth --> Reco
```
