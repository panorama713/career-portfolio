...
| [4. AI 미들웨어(북큐레이션) — 도서관 정보시스템 연계 서비스](projects/04-ai-middleware.md) | 2025.06 ~ | RFID 인증, 개인화 추천 연계, 설치·배포 체계 인수 |
| [5. 도서 추천 시스템 — 대출 이력 기반 추천 데이터 파이프라인](projects/05-recommend-pipeline.md) | 2024.01 ~ | Spring Batch 기반 ETL, 월 60만~180만 건 처리 |
