...
| [2. 도서 추천 시스템 — 대출 이력 기반 추천 데이터 파이프라인](projects/02-recommend-pipeline.md) | 2024.01 ~ | Spring Batch 기반 ETL, 월 60만~180만 건 처리 |
...
| [5. 현장 설치·배포 자동화](projects/05-install-automation.md) | 2024 ~ | 4개 제품에 적용, 기관당 설치 시간 1시간 → 5분 |
